...
const CreateUsername = () => {
  ...
  return (
    <>
      <div className="create-username-page left-content-box-wrapper  p-6 flex-col  flex md:justify-center justify-start items-stretch md:items-center min-h-screen relative">
        <div className="left-content-box flex flex-col items-center justify-center md:mt-0 mt-20">
          ...
          {!!formik.values.username && !formik.errors.username && (
            <img
              src={
                config.FIRESTORE_IMAGE_URL + config.CREATE_USERNAME_MOB_STICKER
              }
              alt="sticker"
      ...
      <div className="flex-1 md:min-h-screen py-8 hidden md:block">
        <div className="h-full w-full flex items-end justify-end relative">
          {!!formik.values.username && !formik.errors.username ? (
            <img
              src={config.FIRESTORE_IMAGE_URL + config.CREATE_USERNAME_STICKER}
              alt="dummy"
            />
          ) : (
            <img

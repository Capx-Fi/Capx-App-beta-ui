...
const EmailLogin = () => {
  ...
  return (
    <>
      <div className="emaillogin-page left-content-box-wrapper  p-6 flex-col  flex md:justify-center justify-start md:mt-0 mt-14 items-stretch md:items-center  min-h-screen relative">

                ...
                <div className="social-wrapper w-3/4 gap-6 flex flex-col">
                    ...
                    <button className="fullname flex flex-row py-3 px-5 justify-between items-center rounded-2xl">
                      <div className="flex flex-row gap-3">
                        ...
                        {/* Target the below class for changing Twitter Handle */}
                          <p className="fs-16 font-bold text-cgreen-700 pt-0.5 opacity-75">Connect your Twitter</p>
                      </div>
                    </button>
                    ...
                    <button className="fullname flex flex-row py-3 px-5 justify-between items-center rounded-2xl">
                       <div className="flex flex-row gap-3">
                        ...
                        {/* Target the below class for changing Twitter Handle */}
                          <p className="fs-16 font-bold text-cgreen-700 pt-0.5 opacity-75">Connect your Discord</p>
                      </div>
                    </button>
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        {/* Target the below class for changing Twitter Handle */}
                          <p className="fs-16 font-bold text-cgreen-700 pt-0.5 opacity-75">Connect your Instagram</p>
                      </div>
                    </button>
                </div>
              </div>

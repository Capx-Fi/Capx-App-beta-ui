...
import {Pfp,Badge,Check,CommProf,TwitterIcon,DiscordIcon,IGIcon,ConnectSo,FullName,
...
{/* Wrapper for Profile Image -----------------------------------------------------------------------------*/}  
                <div className="pfp-bg flex flex-col items-center">
                  <img src={Pfp} alt="" className="pfp-background rounded-full w-4/5 p-1"/>
                </div>
...
{/* Wrapper for Username Chip ----------------------------------------------------------------------------*/}  
                <div className="pfp-username py-3 px-6 rounded-xl my-5">
                  ...
                  <p className="fs-18 font-black">@sherlockho1mes</p>
                </div>
...
{/* Wrapper for Level Progressbar -----------------------------------------------------------------------*/}  
                <div className="pfp-progress flex flex-col gap-3.5 mt-6 ">
                  ...
                  <div className="pfp-progressbar w-full h-5">
                    ...
                    <div className="pfp-progressbar-inner h-5">
                    </div>
                  </div>
                ...
                <div className="pfp-levels flex flex-row justify-between fs-13 font-black c-green-700">
                  <div className="pfp-levels-current flex flex-col items-center gap-1">
                    ...
                    <p className=" pfp-chip px-3 py-1.5 rounded-xl border-1">0 xCapx</p>
                  </div>

                  <div className="pfp-levels-current flex flex-col items-center gap-1">
                    <p className="c-green-700 opacity-70">Level 01</p>
                    <p className=" pfp-chip px-3 py-1.5 rounded-xl border-1">12 xCapx</p>
                  </div>
                </div>
              </div>
          </div>
...
{/* Wrapper for Full Name Chip -------------------------------------------------------------------------*/}  
              ...
              <div className="social-title flex flex-col w-full items-center gap-5">
                  ...
                  <div className="fullname flex flex-row w-full md:w-3/4 py-3 px-4 justify-between items-center rounded-2xl">
                    ...
                    <p className="fs-16 font-bold text-cgreen-700 opacity-75">Sherlock Holmer</p>
                    <img src={Check} alt="" className="pfp-background rounded-full w-7"/>
                  </div>
              </div>
                ...
                <div className="social-wrapper w-full md:w-3/4 gap-6 flex flex-col">
                    ...
                    <div className="fullname flex flex-row py-3 px-5 justify-between items-center rounded-2xl">
                      <div className="flex flex-row gap-3">
                          <img src={TwitterIcon} alt="" className="pfp-background w-6"/>
                        {/* Target the below class for changing Twitter Handle */}
                          <p className="fs-16 font-bold text-cgreen-700 pt-0.5 opacity-75">@sherlockho1mer</p>
                      </div>
                          <img src={Check} alt="" className="pfp-background rounded-full w-7"/>
                    </div>
                    ...
                    <div className="fullname flex flex-row py-3 px-5 justify-between items-center rounded-2xl">
                       <div className="flex flex-row gap-3">
                          <img src={DiscordIcon} alt="" className="pfp-background w-6"/>
                        {/* Target the below class for changing Twitter Handle */}
                          <p className="fs-16 font-bold text-cgreen-700 pt-0.5 opacity-75">@sherho1m#1245</p>
                      </div>
                          <img src={Check} alt="" className="pfp-background rounded-full w-7"/>
                    </div>
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        {/* Target the below class for changing Twitter Handle */}
                          <p className="fs-16 font-bold text-cgreen-700 pt-0.5 opacity-75">@sherlockh01mer</p>
                      </div>
                          <img src={Check} alt="" className="pfp-background rounded-full w-7"/>
                    </div>
                </div>
...
{/* Wrapper for Background Image ---------------------------------------------------------------*/}  
        ...
        <div className="pfp-inner3 flex flex-col basis-1/3 justify-center items-center h-full">
        </div>

...
<p className="quiz-title font-semibold underline underline-offset-4 text-cgreen-700 fs-15 pb-5">Action #2 : Answer the question below</p>
<div className="quiz-box self-stretch mb-10 py-5 pl-5 pr-10 border-1 rounded-2xl">
  ...
  <div className="quiz-answers fs-16 text-cgreen-700 font-medium flex flex-col gap-3 ">
    <a className="answer p-2 px-4 border-1 rounded-2xl">IOU Rewards</a>
    <a className="answer p-2 px-4 border-1 rounded-2xl">XP Rewards</a>
    <a className="answer p-2 px-4 border-1 rounded-2xl">Point Rewards</a>
  </div>
</div>

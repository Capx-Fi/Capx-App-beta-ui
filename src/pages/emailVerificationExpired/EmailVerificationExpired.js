      ...
      <div className="flex min-h-screen">
        <div className="left-content-box-wrapper  p-6 flex-col  flex justify-center  items-stretch md:items-center min-h-screen relative">
          <div className="left-content-box flex gap-8 flex-col items-center justify-center  md:mb-20">
            ...
            {(linkDone === null && linkSocalError === null) ? <h2 className="m-heaidng font-black gredient-text text-center leading-tight pb-1">
              Please Click the button below to
              <br /> verify your email!
            </h2>: linkSocalError === null ? linkDone === true && <h2 className="m-heaidng font-black gredient-text text-center leading-tight pb-1">
              Congratulaions, your email 
              <br /> is verified
              <br/> please sigin to continue on your journey.
            </h2> :linkDone === true && <h2 className="m-heaidng font-black gredient-text text-center leading-tight pb-1">
              Oops! Sorry, your verification
              <br /> link has expired please
              <br /> try signing up again!
            </h2>}

            {(linkDone === null && linkSocalError === null) ? <div className="self-stretch">
              <button onClick={emailVerify} className="signup-btn contained-effect bg-gredient-2 w-full">
                Verify Email
              </button>
            </div>: linkSocalError === null ? linkDone === true && <Link to="/signin/email" className="self-stretch">
              <button className="signup-btn contained-effect bg-gredient-2 w-full">
                Sign In
              </button>
            </Link> : linkDone === true && <Link to="/signup" className="self-stretch">
              <button className="signup-btn contained-effect bg-gredient-2 w-full">
                Sign up
              </button>
            </Link>  }

    ...
    <div className="special w-full">
      <div className="special-wrapper w-64 flex flex-col gap-5 md:flex-row">
        {dailytaskdata.map((data, ind) => {
          return (
            <div
              className={`special-main p-6 basis-1/3  bg-slate-50 md:w-full rounded-2xl flex flex-col gap-12 row${
                ind + 1
              }`}
            >
              ...
              <div className="taskdetailswrapper flex flex-col gap-4">
                ...
                <button className="taskbtn w-full bg-cgreen-500 p-2 rounded-2xl font-extrabold text-cgreen-100 task text-start">
                  {data.taskbtntext}
                </button>

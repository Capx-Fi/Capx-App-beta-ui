        ...
        <div className="mx-auto px-8">
          <div className="flex items-center justify-between  border-gray-100 py-4 md:justify-start md:space-x-10">
            ...
            <Popover.Group as="nav" className="hidden space-x-10 md:flex">
              <Link
                href="#"
                className="fs-14 text-base font-medium text-gray-500 hover:text-gray-900"
              >
                Home
              </Link>
              <Link
            ...
            <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
              <Link
                href="#"
                className="fs-14 outlined-btn px-6 py-1.5 bg-transparent font-semibold hover:text-white whitespace-nowrap border border-gray-900 text-gray-900 hover:border-transparent rounded-xl"
              >
                Sign in
              </Link>
              <Link
                href="#"
                className="fs-14 contained-btn px-6 py-1.5 ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-xl border border-transparent text-base font-medium text-white shadow-sm hover:bg-Gray-900"
              >
                Sign up
              </Link>
            </div>

...
const Onboarding = () => {
  return (
    <>
      <div className="onboarding-page left-content-box-wrapper p-6 flex-col  flex md:justify-center justify:start items-center bg-white-transparent min-h-screen relative">
        <img
        ...
        <div className="left-content-box flex flex-col items-center justify-center mt-12 md:mt-0">
          ...
          <p className="discription fs-16 font-bold text-slate-500 md:text-center md:mb-10 mb-8 hidden md:block">
            Welcome to the world of quests, contests & challenges. Begin your
            web3 journey!
          </p>
          ...
          <Link to="/signin" className=" md:mb-20 self-stretch">
            <div className="md:flex outlined-effect hidden items-center bg-primary-100 border-primary-200 border-1 px-3 py-4 rounded-xl">
              ...
              <div className="flex flex-col items-start ml-4 ">
                <span className="fs-15 font-medium">I’m already a user</span>
                <span className="fs-15 font-medium text-slate-500">
            ...
            <div className="rounded=xl outlined-effect md:hidden flex justify-center self-stretch py-3 rounded-xl border-2 border-primary-200">
              <span className="text-primary-800 font-bold fs-16">Sign in</span>
            </div>
          </Link>

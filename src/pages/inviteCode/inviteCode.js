...
const InviteCode = () => {
  ...
  return (
    <>
      <div className="invite-code-page left-content-box-wrapper  p-6 flex-col  flex md:justify-center justify-start items-stretch md:items-center min-h-screen relative">
        <div className="left-content-box flex flex-col items-center justify-center mb-20 md:mt-0 mt-24">
          ...
          <img
            src={config.FIRESTORE_IMAGE_URL + config.INVITE_CODE_MOB_STICKER}
            alt="sticker"

  ...
  return (
      <div className="banner flex flex-row w-full py-3 px-2 md:p-6 rounded-3xl md:rounder-3xl text-cgreen-100 gap-3">
          ...
          <div className="banner-content flex flex-col justify-center">
            ...
            <p className="text-2xl md:text-4xl -mt-1 md:mt-0 font-black">earned so far!</p>
            <p className="fs-15 font-semibold opacity-80 pt-4">Great going! We have more tasks lined up for you!</p>
          </div>

  ...
  return (
    <div className="codestep flex-col md:ml-20 px-5 md:px-0 md:w-3/5 w-full">
      ...
      <div className="codestep-wrapper w-full flex flex-col gap-6 p-3 md:p-4 border-2 md:rounded-3xl rounded-2xl">
        ...
        <button onClick={(e)=>actionData.handleCompleteAction(e,{type:"inviteCode"})} className="bg-gredient-2 action-btn self-stretch flex w-full justify-center items-center py-4 px-8 gap-2 md:gap-6 rounded-2xl text-white font-semibold fs-16">
